...
println( XLSX2.row_number(cn) ) # will print 1
println( XLSX2.column_number(cn) ) # will print 28
println( string(cn) ) # will print out AB1

cn = XLSX2.CellRef(1, 28)
println( XLSX2.row_number(cn) ) # will print 1
println( XLSX2.column_number(cn) ) # will print 28
println( string(cn) ) # will print out AB1
...
It is created by using [`XLSX2.readxlsx`](@ref) or [`XLSX2.openxlsx`](@ref) 
or [`XLSX2.opentemplate`](@ref) or [`XLSX2.newxlsx`](@ref).

From a `XLSXFile` you can navigate to a `XLSX2.Worksheet` reference
