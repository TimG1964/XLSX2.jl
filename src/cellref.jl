...
# Converts column name to a column number. See also XLSX2.encode_column_number.
...
# Converts column number to a column name. See also XLSX2.decode_column_number.
...
```julia
julia> XLSX2.split_cellrange("AB12:CD24")
("AB12", "CD24")
```
=#
